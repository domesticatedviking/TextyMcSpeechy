...
class DatasetRecorder:
    ...
    def record_audio(self):
        ...
        try:
            ...
            self.status_var.set(f"Error recording: {str(e)}")
            self.root.after(0, self.stop_recording)
    ...
    def stop_recording(self):
        ...
        if self.frames and self.current_index < len(self.filenames):
            ...
            try:
                ...
                self.status_var.set(f"Error saving recording: {str(e)}")
    ...
    def generate_audio_thread(self, text, output_path, index):
        ...
        try:
            ...
            self.root.after(0, lambda: self.status_var.set(f"Error generating audio: {str(e)}"))
    ...
    def generate_all_missing_thread(self, indices):
        ...
        for i, idx in enumerate(indices):
            ...
            try:
                ...
                self.root.after(0, lambda: self.status_var.set(f"Error generating {filename}: {str(e)}"))
    ...
    def record_room_tone(self, output_path):
        ...
        try:
            ...
            messagebox.showerror("Error", f"Failed to record room tone: {str(e)}")
    ...
    def run_room_tone_removal(self, input_dir, output_dir, roomtone_file):
        ...
        try:
            ...
            self.root.after(0, lambda: messagebox.showerror("Error", f"Room tone removal failed: {str(e)}"))
