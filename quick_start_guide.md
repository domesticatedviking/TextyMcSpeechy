...
1. clone the TextyMcspeechy repository if you haven't already done so. `git clone https://github.com/domesticatedviking/TextyMcSpeechy.git` (If on Ubuntu/PopOS you have to install python3.10-env and python3.10-dev, sudo apt-get install python3.10-dev python3.10-venv)
